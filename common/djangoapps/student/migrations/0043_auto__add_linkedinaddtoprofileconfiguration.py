...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('student_linkedinaddtoprofileconfiguration', (
            ...
            ('dashboard_tracking_code', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
    ...
    models = {
        ...
        'student.linkedinaddtoprofileconfiguration': {
            ...
            'change_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'dashboard_tracking_code': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
